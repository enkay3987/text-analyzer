...
/**
 * Basic implementation of a text location for a text chunk
 */
public class TextChunkLocationDefaultImpl implements TextChunkLocation {
    /**
    ...
    public TextChunkLocationDefaultImpl(Vector startLocation, Vector endLocation, float charSpaceWidth) {
    ...
    public int compareTo(TextChunkLocation other) {
        ...
        int rslt;
        rslt = Utils.compareInts(orientationMagnitude(), other.orientationMagnitude());
        if (rslt != 0) return rslt;

        rslt = Utils.compareInts(distPerpendicular(), other.distPerpendicular());
        if (rslt != 0) return rslt;
